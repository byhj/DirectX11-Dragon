...
namespace byhj
{
	namespace d3d
	{
		...
		UINT Wave::RowCount()const
		{
			return mNumRows;
		}

		UINT Wave::ColumnCount()const
		{
			return mNumCols;
		}

		UINT Wave::VertexCount()const
		{
			return mVertexCount;
		}

		UINT Wave::TriangleCount()const
		{
		...
		void Wave::Init(UINT m, UINT n, float dx, float dt, float speed, float damping)
		{
			mNumRows  = m;
			mNumCols  = n;
