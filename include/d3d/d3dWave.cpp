...
UINT D3DWave::RowCount()const
{
	return mNumRows;
}

UINT D3DWave::ColumnCount()const
{
	return mNumCols;
}

UINT D3DWave::VertexCount()const
{
	return mVertexCount;
}

UINT D3DWave::TriangleCount()const
{
	return mTriangleCount;
}

void D3DWave::Init(UINT m, UINT n, float dx, float dt, float speed, float damping)
{
	mNumRows  = m;
	mNumCols  = n;
...
void D3DWave::Disturb(UINT i, UINT j, float magnitude)
{
