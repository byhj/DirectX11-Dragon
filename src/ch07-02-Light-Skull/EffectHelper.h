...
public:
	...
	void SetDirLight(const d3d::DirectionLight &dirLight);
	void SetPointLight(const d3d::PointLight &pointLight);
	void SetSpotLight(const d3d::SpotLight &spotLight);
	void SetMaterial(const d3d::Material &mat);
