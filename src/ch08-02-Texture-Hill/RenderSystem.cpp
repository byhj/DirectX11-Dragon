...
void RenderSystem::v_Render()
{
	...
	//XMMATRIX Hill = XMMatrixTranslation(0.0f, 0.0f, -0.5f);
   // XMStoreFloat4x4(&m_Matrix.Hill, XMMatrixTranspose(Hill));

	m_Hill.Render(m_pD3D11DeviceContext, m_Matrix.model, m_Matrix.view, m_Matrix.proj,
		         &m_Timer, &m_Camera);
